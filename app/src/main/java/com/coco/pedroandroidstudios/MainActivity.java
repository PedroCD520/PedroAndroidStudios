package com.coco.pedroandroidstudios;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        burgerCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> productsSelection.put("Bowl", isChecked));
        completoCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> productsSelection.put("Sandwich", isChecked));
        pizzaCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> productsSelection.put("Fajita", isChecked));
        drinksCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> productsSelection.put("Moster", isChecked));
